...
import { MEALS, DEFAULT_PLAN, getMeal, labelPlan, autoBuildPlan } from "./data/meals";
import { blankDay, loadData, loadSettings, saveData, saveSettings, todayKey } from "./data/storage";
import "./styles.css";
...
function App() {
  ...
  const day = allData[activeDate] || blankDay(DEFAULT_PLAN);
